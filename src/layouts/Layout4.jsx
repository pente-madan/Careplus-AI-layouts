    ...
    <div className="w-full bg-white">
      ...
      <div className="bg-white relative w-full overflow-hidden border-t border-slate-50">
          ...
          <div className="hidden lg:flex relative mx-auto w-[1280px] h-[700px] items-center justify-start px-6 mb-[150px]">
              ...
              <div className="relative top-[180px] ml-auto mr-[-100px] w-[650px] bg-white/95 backdrop-blur-xl p-12 rounded-[24px] shadow-xl border border-white/50 flex flex-col gap-8 transition-all duration-500 hover:-translate-y-2 hover:shadow-2xl">
                  ...
                  <h2 className="text-[56px] font-bold text-slate-900 leading-[1.1] tracking-tight">
                      Healthy Eyes,<br/>
                  ...
                  <button className="w-fit px-8 py-4 bg-red-600 text-white rounded-lg font-bold text-[16px] overflow-hidden transition-all hover:shadow-lg hover:bg-red-700 flex items-center gap-3">
          ...
          <div className="lg:hidden flex flex-col w-full">
              ...
              <div className="p-8 bg-white border-t border-slate-100 shadow-lg -mt-6 relative z-10 rounded-t-3xl mx-4">
                  <span className="text-red-600 font-bold tracking-[0.15em] text-xs uppercase block mb-2">Vision Care</span>
                  <h2 className="font-bold text-slate-900 text-4xl mb-2 tracking-tight">Healthy Eyes</h2>
                  <h2 className="font-bold text-slate-400 text-4xl mb-4 tracking-tight">Brighter Future</h2>
                  ...
                  <button className="w-full py-4 bg-red-600 text-white rounded-lg font-bold text-sm hover:bg-red-700 transition-colors">
                      Book Appointment
                  </button>
              </div>
